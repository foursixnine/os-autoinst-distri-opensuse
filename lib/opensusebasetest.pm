...
sub handle_additional_polkit_windows {
    record_soft_failure 'bsc#1177446 or bsc#1168979 - polkit popup appears when it should not';
    wait_still_screen(3);
...
sub wait_boot_past_bootloader {
    ...
    # bsc#1177446 or bsc#1168979 - Polkit pop-up appears when it shouldn't
